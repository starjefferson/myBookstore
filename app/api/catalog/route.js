...
// Cache for 3.5 days (302,400,000 ms) to align with twice-weekly sync (Monday & Thursday 2 AM UTC)
...
export async function GET(request) {
  try {
    ...
    const cacheIsFresh =
      catalogCache && Date.now() - catalogCache.createdAt < CATALOG_CACHE_TTL;
